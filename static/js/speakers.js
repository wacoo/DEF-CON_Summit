...
const data = [
  {
    ...
    description:
      'Charlie won the Pwn2Own computer hacking contest four times. He found a vulnerability that would allow hacking into 1.4 million vehicles. He has worked for many high-tech companies including Twitter and Uber.',
  },
  {
    ...
    description:
      'Hoglund is a crucial feature in our list of ethical hackers. Some of the areas he is best known for working in include physical memory forensics, attribution of hackers and malware detection.',
  },
  {
    img_path: 'static/images/kevin2.jpg',
    name: 'Kevin Mitnick',
    occupation:
      'Former Black Hat hacker, the most high-profile hacker in recent history',
    description:
      'Mitnick’s activities breaching major corporations for his amusement earned him a place on the FBI’s most-wanted list. He was arrested in 1995 and served five years in prison.',
  },
  {
    img_path: 'static/images/Tsutomu-Shimomura.jpg',
    name: 'Tsutomu Shimomura',
    occupation:
      'A cybersecurity expert, physicist, and is credited with tracking down Kevin Mitnick.',
    description:
      'Being a computational physics research scientist, Shimomura also worked for the National Security Agency (NSA). He was known to be one of the leading researchers who raised awareness of the lacking security and privacy of cellular phones at that time.',
  },
  {
...
function populateFutureSpeakers(count) {
  ...
  for (let i = 0; i < count; i += 1) {
    const speaker = `<div class="feature_card">
            <div class="icon">
  ...
  if (count === 2) {
    ...
    <a href="#">MORE <img src="static/images/arrow_up.png" alt=""></a>
    </div>`;
    parent.innerHTML += btn;
  } else {
    const btn = `<div class="btn_more" id="btn_more">
    <a href="#">LESS <img src="static/images/arrow_down 1.png" alt=""></a>
    </div>`;
    parent.innerHTML += btn;
  }
}
...
function moreButtonListener() {
  ...
  if (more) {
    more.addEventListener('click', (event1) => {
